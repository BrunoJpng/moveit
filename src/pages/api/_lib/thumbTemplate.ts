...
export default function getThumbnailTemplate(props: ThumbnailProps) {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
      ...
      <style>
        * {
        ...
        .thumbnailContainer section > div:first-child {
          text-align: center;
        }
        
        .thumbnailContainer header {
          font-size: 19.125rem;
          font-weight: 700;
      ...
      <div class="thumbnailContainer">
        <section>
          ...
          <div>
            <div>
              <p>DESAFIOS</p>
              <span class="number">${props.challengesCompleted} </span>
